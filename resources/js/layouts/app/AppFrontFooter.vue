    ...
    <footer class="bg-gray-800 text-gray-200 py-12 mt-12">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                <!-- Company Info -->
                <div>
                    <h3 class="text-xl font-bold mb-4">DigitalMarket</h3>
                    <p class="text-gray-400 mb-4">Your one-stop shop for premium digital products and resources.</p>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="/help" class="text-gray-400 hover:text-white">Help & FAQ</a></li>
                        <li><a href="/license" class="text-gray-400 hover:text-white">License Agreement</a></li>
                        <li><a href="/refund" class="text-gray-400 hover:text-white">Refund Policy</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <form @submit.prevent="subscribeNewsletter" class="flex flex-col space-y-2">
                        <input 
                            ...
                            class="px-4 py-2 bg-gray-700 text-white rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                            required
            ...
            <div class="pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
                <div class="mb-4 md:mb-0">&copy; 2025 DigitalMarket. All rights reserved.</div>
                <div class="text-sm">
                    ...
                    <a href="/affiliate" class="text-gray-400 hover:text-white mx-2">Affiliate Program</a>
                </div>
            </div>
        </div>
    </footer>
